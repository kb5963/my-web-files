...
async buildEngine() {
    ...
    try {
        ...
        self.engineThread_.onmessage = function(event) {
            if (event.data.includes("Stockfish")) console.log("System: Engine is ONLINE (Plan B)");
            self.fromEngine(event);
        };

        // Change this line in your buildEngine:
        self.engineThread_.onmessage = (event) => { // Use => here
