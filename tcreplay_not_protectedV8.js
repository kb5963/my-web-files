...
buildEngine() {
  var self = this;
  // The folder where the .js and the 6 .wasm-parts live
  ...
  fetch(engineJsUrl)
    ...
    .then(function(scriptText) {
      // We force 's' to be the full GitHub URL.
      // This ensures the internal 'fetch' finds part-0, part-1, etc. on GitHub.
      ...
      self.h2x.onmessage = function(event) { self.o5f(event); };
