...
async buildEngine() {
    ...
    try {
        ...
        // THE OVERRIDE: This is the strongest way to force the path
        var pathFix =
            "var Module = {\n" +
            "  locateFile: function(path, prefix) {\n" +
            "    if (path.endsWith('.wasm') || path.includes('-part-')) {\n" +
            "      return '" + folderUrl + "' + path;\n" +
            "    }\n" +
            "    return path;\n" +
            "  },\n" +
            "  mainScriptUrlOrBlob: '" + engineJsUrl + "'\n" + // This helps it find its home
            "};\n" +
            "var s = '" + engineJsUrl + "';\n"; // This helps the p(n) function find the parts
