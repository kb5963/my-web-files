...
buildEngine() {
  var self = this;
  // Use the RAW URL - it has better CORS support for fetch
  ...
  fetch(engineJsUrl)
    ...
    .then(function(scriptText) {
      // Inject WASM fix so it finds the brain on the .io site
      ...
      self.engineThread_.onmessage = function(e) { self.fromEngine(e); };
